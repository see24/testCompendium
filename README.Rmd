...
Launch the [`make.R`](https://github.com/see24/testCompendium/tree/master/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/see24/testCompendium/blob/main/CONTRIBUTING.md).
